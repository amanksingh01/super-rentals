...
module('Acceptance | list rentals', function(hooks) {
  ...
  test('should filter the list of rentals by city', async function(assert) {
    ...
    assert.ok(
      this.element.querySelector('.listing .location').textContent.includes('Seattle'),
  ...
  test('should show details for a specific rental', async function(assert) {
    ...
    assert.ok(this.element.querySelector('.show-listing .description'), 'should list a desciption of the property');
  });
});
